    ...
    return (
        <Card style={styles.card}>
            ...
            <CardAction separator={true}>
                <CardButton onPress={() => {playbackObject.playAsync()}} title="Play" />
                <CardButton onPress={() => {playbackObject.pauseAsync()}} title="Pause" />
            </CardAction>
        </Card>
    );
};
...
const FeedScreen = () => {
    ...
    useEffect(() => {
        const getRandomVerse = async () => {
            ...
            const URL = API + 'verses/random?words=false&translations=203%2C89&audio=6';
            // console.log(URL);
